...
# Project Outline – Part 2: Traffic Flow, Stability, and Simulation Model
...
**Linearized perturbation idea:**

[
\rho(x,t)=\rho_0+\epsilon e^{ikx+st}
]

**Stability interpretation:**

[
Re(s)<0 \Rightarrow \text{perturbation decays}
]

[
Re(s)>0 \Rightarrow \text{perturbation grows}
]
...
Congestion mode decays; the network returns toward equilibrium.

[
Re(\lambda_i)>0
]

Congestion mode grows; the network is unstable under that condition.

**Complex eigenvalues:** Oscillatory propagation; stop-and-go waves or periodic queue behavior.

**Eigenvectors:** Identify which road segments or intersections participate most strongly in each unstable mode.

**Annotation:** This section functions as the systems-engineering stability model.
